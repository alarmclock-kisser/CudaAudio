...
namespace CudaAudio.Core
{
	public static class CommonStatics
	{
		...
		public static int OperationalThreads => CommonStatics.AdjustWorkersCount(CommonStatics.ThreadSetting - CommonStatics.PlaybackThreads);
		public static int PlaybackThreads = 0;
		public static int ThreadSetting = -2;
